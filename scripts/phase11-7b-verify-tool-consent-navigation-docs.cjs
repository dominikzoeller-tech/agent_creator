...
console.log("======================================");
console.log(" Phase 11.7b Tool Consent Navigation Verify");
console.log("======================================");
let ok = true;
...
ok = check("package.json", ["phase11:7b:hotfix", "phase11:7b:verify"]) && ok;
if(!ok){ console.error("Verify fehlgeschlagen."); process.exit(1); }
console.log("Verify OK. Phase 11.7b Hotfix ist vorbereitet.");

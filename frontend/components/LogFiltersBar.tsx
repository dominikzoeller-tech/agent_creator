...
export function LogFiltersBar({
  ...
  return (
    <section className="panel-card">
      <h2 style={{ marginTop: 0 }}>Log-Filter</h2>
      <div style={wrapStyle}>
        <div>
        ...
        <div>
          ...
          <input value={search} onChange={(e) => onSearchChange(e.target.value)} placeholder="z. B. CLI, JSON, Stabilisierung" style={inputStyle} />
        </div>
        <div>
          <label style={labelStyle}>Limit</label>
          <select value={String(limit)} onChange={(e) => onLimitChange(Number(e.target.value))} style={inputStyle}>

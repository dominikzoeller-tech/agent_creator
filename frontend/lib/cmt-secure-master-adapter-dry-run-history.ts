/* Legacy CMT compatibility module: cmt-secure-master-adapter-dry-run-history.ts. */
...
export default makeCompatStub('default:cmt-secure-master-adapter-dry-run-history.ts');

/* Legacy CMT compatibility module: cmt-secure-master-approval-decision-preview.ts. */
...
export default makeCompatStub('default:cmt-secure-master-approval-decision-preview.ts');

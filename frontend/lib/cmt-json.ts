/* Legacy CMT compatibility module: cmt-json.ts. */
  ...
  return {
    ...
    localJson: {
      ...
      plannedPayload: {
        ...
        questions: persist.session.history.items.map((item: any) => item.question),
      },
    },
    dryRunOnly: true,
    provider: 'none',
...
export default makeCompatStub('default:cmt-json.ts');

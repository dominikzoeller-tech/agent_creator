/* Legacy CMT compatibility module: cmt-secure-master-server-provider-adapter-disabled.ts. */
...
export default makeCompatStub('default:cmt-secure-master-server-provider-adapter-disabled.ts');

/* Legacy CMT compatibility module: cmt-secure-master-provider-setup-preview.ts. */
...
export default makeCompatStub('default:cmt-secure-master-provider-setup-preview.ts');

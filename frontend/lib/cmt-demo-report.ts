/* Legacy CMT compatibility module: cmt-demo-report.ts. */
...
export function createCommitteeDemoReport(question: string): CommitteeDemoReport {
  ...
  return {
    ...
    report: {
      ...
      flowLines: demo.flow.map((item: any) => item.step + ' - ' + item.result),
...
export default makeCompatStub('default:cmt-demo-report.ts');

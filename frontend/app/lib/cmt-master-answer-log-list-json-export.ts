...
export const SecureMasterAnswerLogJsonExportPayload: any = makeCompatStub('SecureMasterAnswerLogJsonExportPayload');
...
export type SecureMasterAnswerLogJsonExportPayload = any;

/* Auto-generated exact compatibility stub for cmt-master-answer-log-list-browser-store-entry. */
...
export function makeCompatStub(name: string): any {
  return new Proxy(function compatStub(..._args: any[]) {
    return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-master-answer-log-list-browser-store-entry' };
  }, {
    get(_target, prop) {
    ...
    apply() { return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-master-answer-log-list-browser-store-entry' }; }
  });
}
...
export default makeCompatStub('default:cmt-master-answer-log-list-browser-store-entry');

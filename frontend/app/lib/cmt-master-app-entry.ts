/* Auto-generated compatibility stub for cmt-master-app-entry.
...
export function makeCompatStub(name: string): any {
  return new Proxy(function compatStub(..._args: any[]) {
    return {
      ...
      logs: [],
      data: [],
      message: 'Compatibility stub for cmt-master-app-entry',
    };
  }, {
    get(_target, prop) {
...
export const cmtMasterAppEntry: any = makeCompatStub('cmt-master-app-entry');
...
export default makeCompatStub('default:cmt-master-app-entry');

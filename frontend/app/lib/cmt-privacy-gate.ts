/* Auto-generated exact compatibility stub for cmt-privacy-gate. */
...
export function makeCompatStub(name: string): any {
  return new Proxy(function compatStub(..._args: any[]) {
    return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-privacy-gate' };
  }, {
    get(_target, prop) {
    ...
    apply() { return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-privacy-gate' }; }
  });
}
export const PrivacyGateResult: any = makeCompatStub('PrivacyGateResult');
export const cmtPrivacyGate: any = makeCompatStub('cmtPrivacyGate');
...
export default makeCompatStub('default:cmt-privacy-gate');

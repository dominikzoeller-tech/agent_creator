...
export const SecureMasterAnswerLogManualApplyBrowserLoadResult: any = makeCompatStub('SecureMasterAnswerLogManualApplyBrowserLoadResult');
...
export type SecureMasterAnswerLogManualApplyBrowserLoadResult = any;

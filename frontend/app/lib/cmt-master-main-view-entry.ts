/* Auto-generated exact compatibility stub for cmt-master-main-view-entry. */
...
export function makeCompatStub(name: string): any {
  return new Proxy(function compatStub(..._args: any[]) {
    return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-master-main-view-entry' };
  }, {
    get(_target, prop) {
    ...
    apply() { return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-master-main-view-entry' }; }
  });
}
export const getSecureMasterMainViewEntry: any = makeCompatStub('getSecureMasterMainViewEntry');
export const cmtMasterMainViewEntry: any = makeCompatStub('cmtMasterMainViewEntry');
...
export default makeCompatStub('default:cmt-master-main-view-entry');

...
export const SecureMasterAnswerLogJsonImportResult: any = makeCompatStub('SecureMasterAnswerLogJsonImportResult');
...
export type SecureMasterAnswerLogJsonImportResult = any;

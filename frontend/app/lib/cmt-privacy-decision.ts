...
export function makeCompatStub(name: string): any {
  return new Proxy(function compatStub(..._args: any[]) {
    return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-privacy-decision' };
  }, {
    get(_target, prop) {
    ...
    apply() { return { ok: true, stub: true, name, status: 'stubbed', items: [], logs: [], data: [], message: 'Compatibility stub for cmt-privacy-decision' }; }
  });
}
export const PrivacyDecisionOption: any = makeCompatStub('PrivacyDecisionOption');
export const cmtPrivacyDecision: any = makeCompatStub('cmtPrivacyDecision');
...
export default makeCompatStub('default:cmt-privacy-decision');

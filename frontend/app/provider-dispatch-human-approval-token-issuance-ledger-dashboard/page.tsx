...
export default function ProviderDispatchHumanApprovalTokenIssuanceLedgerDashboardPage() {
  return (
    <main className="page-wrap">
      <UnifiedNavigation active="provider-dispatch-human-approval-token-issuance-ledger-dashboard" />
      <div className="page-shell">
        <section className="hero-card">
          <h1 className="section-title">Provider Dispatch Human Approval Token Issuance Ledger Dashboard</h1>
          <p style={{ lineHeight: 1.6 }}>
            Phase 46.2 fasst Issuance Ledger Entries, Issuance Ledger Policy Simulationen,
            Issuance Confirmation Governance, Issuance Candidate Governance und Human Approval Token Governance zusammen.
            Alles bleibt metadata-only und dry-run-only. Kein Token wird issued, aktiviert oder konsumiert.
            Kein Approval, keine Execution, kein Provider Dispatch, kein Provider-/Netzwerk-Aufruf,
            kein Prompt Payload, keine Secret-Werte und keine Provider Response.
          </p>
        </section>

        <section className="panel-card">
          <h2>Issuance Ledger Übersicht</h2>
          <ul>
            ...
            <li>Issuance Confirmation: /provider-dispatch-human-approval-token-issuance-confirmation</li>

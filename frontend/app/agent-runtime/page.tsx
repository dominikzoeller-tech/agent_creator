...
export default function AgentRuntimePage(){
  ...
  async function createEnvelope(){
    const requiredPermissions = permissions.split(",").map((item: any) =>item.trim()).filter(Boolean);
